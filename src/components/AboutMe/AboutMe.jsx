      ...
      <div className="about-me__wrap">
        ...
        <div className="about-me__info-wrap">
          ...
          <p className="about-me__info">На данный момент общий опыт во frontend разработке более года, хорошее знание HTML(BEM), CSS(SASS/SCSS), JS, React/Redux(Saga) и React Native(около 3 месяцев).
            Имею опыт разработки 2-х fullstack SPA на React с нуля до деплоя на сервер. Есть базовое понимание основ Vue/Vuex и TypeScript.
            Также есть базовые знания бэкенд части - писал бэк с нуля для своих проектов(Node.js, Express.js, MongoDB, RESTful API). Уверенно использую инфраструктурные инструменты - Git, Webpack, ESlint.
